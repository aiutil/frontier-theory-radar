...
## Latest research run · 2026-08-29

| Papers reviewed | Immediate | Trend | Long tail | Deferred |
| ---: | ---: | ---: | ---: | ---: |
| 10 | 100 | 138 | 123 | 1289 |

**Deep dive:** [WikiSkill: Compiling Agent Experience into Persistent Knowledge for Skill Evolution](daily/2026/2026-08-29.md) · Immediate · 轻量试点
